...
data_location = '/home/data/NDClab/datasets/mfe-jr-dataset/derivatives/eeg/TF_outputs/compiled';

%% Save Location - this is the location where you would like your csv files to be stored. 
save_location = '/home/data/NDClab/datasets/mfe-jr-dataset/derivatives/eeg/TF_outputs/csv_for_stats';
...
%% File list
cd('/home/data/NDClab/datasets/mfe-jr-dataset/derivatives/eeg/TF_outputs/main') % location of the files that are outputs of the 'mainscript_calculate_TF_ITPS_ICPS' script!
subnum=dir('*.mat');
